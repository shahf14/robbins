...
export function WeeklyReviewCard({
    ...
    return (
      <article className="panel-surface p-5" aria-label={t('lifeCoach.weeklyReview')}>
        <div className="flex flex-wrap items-center justify-between gap-2">
          <p className="field-label mb-0 text-white/45" aria-hidden="true">{t('lifeCoach.weeklyReview')}</p>
          <div className="flex flex-wrap items-center gap-2">
            {isGoodTime ? (
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/3 px-2.5 py-1 text-[11px] font-semibold text-white/40">
        ...
        <div className="relative mt-4 overflow-hidden rounded-[18px] border border-dashed border-white/12 bg-white/[0.015] p-4">
          <div className="select-none blur-[2px]" aria-hidden>
            <div className="h-3 w-3/4 rounded-full bg-white/10" />
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="rounded-[14px] border border-white/10 bg-white/3 p-3">
                <div className="h-2.5 w-12 rounded-full bg-white/10" />
                <div className="mt-3 h-5 w-8 rounded-full bg-white/8" />
              </div>
              <div className="rounded-[14px] border border-white/10 bg-white/3 p-3">
                <div className="h-2.5 w-12 rounded-full bg-white/10" />
                <div className="mt-3 h-5 w-16 rounded-full bg-white/8" />
              </div>
            </div>
            <div className="mt-3 h-2.5 w-full rounded-full bg-white/7" />
            <div className="mt-2 h-2.5 w-5/6 rounded-full bg-white/7" />
          </div>
  ...
  return (
    <article className="panel-surface p-5" aria-label={t('lifeCoach.weeklyReview')}>
      ...
      <WeeklyReviewExplainer className="mt-4" />
      <p className="mt-3 text-lg font-bold text-white">{insight.content}</p>
      {metadata ? (
        <>
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-[18px] border border-white/10 bg-white/3 p-4">
              <p className="field-label mb-0 text-white/45">{t('lifeCoach.completedSteps')}</p>
              <p className="mt-2 text-2xl font-black text-white">{metadata.completed_steps_count}</p>
            </div>
            <div className="rounded-[18px] border border-white/10 bg-white/3 p-4">
              <p className="field-label mb-0 text-white/45">{t('lifeCoach.mainBlocker')}</p>
              <p className="mt-2 text-base font-semibold text-white">{metadata.main_blocker}</p>
            </div>
          </div>
